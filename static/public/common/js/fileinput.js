    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            var self = this, tMain1, tMain2, tPreview, tFileIcon, tClose, tCaption, tBtnDefault, tBtnLink, tBtnBrowse,
                ...
                tText, tVideo, tAudio, tFlash, tObject, tPdf,tZip,tRar,tOther, tZoomCache, vDefaultDim;
            ...
            tZip = '<div class="kv-preview-data file-preview-other-frame" {style}>\n' + $h.DEFAULT_PREVIEW + '\n</div>\n';
            tRar = '<div class="kv-preview-data file-preview-other-frame" {style}>\n' + $h.DEFAULT_PREVIEW + '\n</div>\n';
            ...
            self.defaults = {
                ...
                allowedPreviewTypes: ['image', 'html', 'text', 'video', 'audio', 'flash', 'pdf','zip','rar', 'object'],
                previewTemplates: {},
                previewSettings: {
                    ...
                    zip: {width: "213px", height: "60px"},
                    rar: {width: "213px", height: "60px"},
                ...
                previewSettingsSmall: {
                    ...
                    zip: {width: "100%", height: "160px"},
                    rar: {width: "100%", height: "160px"},
                ...
                previewZoomSettings: {
                    ...
                    pdf: vDefaultDim,
                    zip: {width: "auto", height: "100%", 'min-height': "480px"},
                    rar: {width: "auto", height: "100%", 'min-height': "480px"},
                ...
                fileTypeSettings: {
                    ...
                    zip: function (vType, vName) {
                        return $h.compare(vType, 'application/zip', true) || $h.compare(vName, /\.(zip)$/i);
                    },
                    rar: function (vType, vName) {
                        return $h.compare(vType, 'application/rar', true) || $h.compare(vName, /\.(rar)$/i);
                    },
                    object: function () {
                        return true;
                    },
