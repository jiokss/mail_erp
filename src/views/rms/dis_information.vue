    ...
    <div class="queryMain app-container">
      ...
      <el-card class="filter-container" shadow="never" style="margin-top:15px;">
        <div style="margin-bottom:25px;">
          ...
          <div :style="headerBtnList.length>0?'':'margin-bottom:25px'" class="demo-form-inline float_right">
...
export default {
   data() {
      return {
        ...
        ReqCode:'',
        checkedCities:[],
        menuCodeList:'medical_dis_report',
        formatted:'formatted',
      }
   },
   activated() {
...
//      _this.menuList = datas.data
     ...
     getform(type){
      ...
      var url = this.$path.EditNoticeRecord+'?type=25&posttype=1'
